...
ARG COMPLY_VERSION
ENV COMPLY_VERSION ${COMPLY_VERSION:-1.4.2}

EXPOSE 4000/tcp

# install comply binary
RUN curl -J -L -o /tmp/comply.tgz https://github.com/GrahamBurek/comply/releases/download/v${COMPLY_VERSION}/comply-v${COMPLY_VERSION}-linux-amd64.tgz \
